...
filteredData <- warmExpData %>%
  ...
  filter(
    lesionPercent <= meanLesionPercent + 2.5 * sdLesionPercent,
    percentLengthPedByIsolate <= meanPercentLength + 2.5 * sdPercentLength,
    percentMassPedByIsolate <= meanPercentMass + 2.5 * sdPercentMass
  )
