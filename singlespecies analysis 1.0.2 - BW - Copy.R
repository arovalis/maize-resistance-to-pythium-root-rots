...
data <- read_csv(dfDir) # Reads if it is a .xlsx file. If it is a csv, change read_excel to read_csv
...
noEscapeData <- data[!grepl("1", data$escape),]
cleanData <- noEscapeData[!grepl("Il14H", noEscapeData$pedigree),]
...
summary(aov(percentLengthPedByIsolate ~ pedigree * isolateSpecies + repetition + block, exp_data))
summary(aov(percentMassPedByIsolate ~ pedigree * isolateSpecies + repetition + block, exp_data))
summary(aov(lesionPercent ~ pedigree * isolateSpecies + repetition + block, exp_data))
...
capture.output({
  ...
  print(summary(aov(lesionPercent ~ pedigree * isolateSpecies + repetition + Error(block/pedigree), exp_data)))
  
  cat("\n\nSummary of ANOVA for percentLengthPedByIsolate:\n")
  print(summary(aov(percentLengthPedByIsolate ~ pedigree * isolateSpecies + repetition + Error(block/pedigree), exp_data)))
  
  cat("\n\nSummary of ANOVA for percentMassPedByIsolate:\n")
  print(summary(aov(percentMassPedByIsolate ~ pedigree * isolateSpecies + repetition + Error(block/pedigree), exp_data)))
}, file = anovaFile)


model_lesion <- aov(lesionPercent ~ isolateSpecies + repetition, exp_data)
model_length <- aov(percentLengthPedByIsolate ~ isolateSpecies + repetition, exp_data)
model_mass <- aov(percentMassPedByIsolate ~ isolateSpecies + repetition, exp_data)
...
NoControlData <- data[!grepl("Standard", data$isolateSpecies),]
...
summary(aov(lesionPercent ~ pedigree + repetition+block, NoControlData))
summary(aov(percentLengthPedByIsolate ~ pedigree + repetition+block, NoControlData))
summary(aov(percentMassPedByIsolate ~ pedigree + repetition+block, NoControlData))
...
puuData <- data[grepl("G.uu", data$isolateSpecies),]
...
capture.output({
  cat("Summary of ANOVA for lesionPercent:\n")
  print(summary(aov(lesionPercent ~ pedigree + block, puuData)))
  
  cat("\n\nSummary of ANOVA for percentLengthPedByIsolate:\n")
  print(summary(aov(percentLengthPedByIsolate ~ pedigree + block, puuData)))
  
  cat("\n\nSummary of ANOVA for percentMassPedByIsolate:\n")
  print(summary(aov(percentMassPedByIsolate ~ pedigree + block, puuData)))
}, file = anovaFile)
...
model_lesion <- aov(lesionPercent ~ pedigree, puuData)
model_length <- aov(percentLengthPedByIsolate ~ pedigree, puuData)
model_mass <- aov(percentMassPedByIsolate ~ pedigree, puuData)
...
MassAnova <- lmer(percentMassPedByIsolate ~ isolate * pedigree + repetition + (1|block), dataForTransformation)
Anova(MassAnova, Type = "III")

summary(aov(percentLengthPedByIsolate ~ pedigree + repetition + block, dataForTransformation))
...
MassAnova <- lmer(percentMassPedByIsolate_transformed ~ isolate * pedigree + repetition + (1|block), dataForTransformation)
Anova(MassAnova, Type = "III")
...
LengthAnova <- lmer(percentLengthPedByIsolate ~ isolate * pedigree + repetition + (1|block), dataForTransformation)
summary(LengthAnova)
...
NecrosisAnova <- lmer(lesionPercent ~ isolate * pedigree + repetition + (1|block), dataForTransformation)
...
############################################## TRANSFORMED ANOVAS ###########################################
#############################################################################################################
summary(aov(percentMassPedByIsolate_transformed ~ isolate * pedigree + repetition + block, dataForTransformation))
summary(aov(percentLengthPedByIsolate_transformed ~ isolate * pedigree + repetition + block, dataForTransformation))
summary(aov(lesionPercent_transformed ~ isolate * pedigree + repetition + block, dataForTransformation))
#############################################################################################################
#############################################################################################################
#############################################################################################################
...
model_lesion <- aov(lesionPercent_transformed ~ isolateSpecies + repetition, dataForTransformation)
model_length <- aov(percentLengthPedByIsolate_transformed ~ isolateSpecies + repetition, dataForTransformation)
model_mass <- aov(percentMassPedByIsolate_transformed ~ isolateSpecies + repetition, dataForTransformation)
...
model_lesion <- aov(lesionPercent_transformed ~ pedigree, dataForTransformation)
model_length <- aov(percentLengthPedByIsolate_transformed ~ pedigree, dataForTransformation)
model_mass <- aov(percentMassPedByIsolate_transformed ~ pedigree, dataForTransformation)
...
model_lesion <- aov(lesionPercent_transformed ~ pedigree, puuDataTransformed)
model_length <- aov(percentLengthPedByIsolate_transformed ~ pedigree, puuDataTransformed)
model_mass <- aov(percentMassPedByIsolate_transformed ~ pedigree, puuDataTransformed)
...
################################################################################################################
model <- cor.test(
  ogData$lesionPercent, 
  ogData$percentLengthPedByIsolate, 
  method = "pearson"
)
...
model <- cor.test(ogData$percentMassPedByIsolate, ogData$percentLengthPedByIsolate, method = "pearson")
...
model <- cor.test(ogData$percentMassPedByIsolate, ogData$lesionPercent, method = "pearson")
